...
exports.default = exports.createReducer = void 0;
...
var wrapFunction = function wrapFunction(fn, parentName, actionName) {
  return function () {
    ...
    var partialState = fn.apply(void 0, [stateCopy, _reducers].concat(args));

    if (partialState instanceof Promise) {
      partialState.then(function (result) {
        updateState(stateCopy, result, parentName);
        applyMiddlewares("".concat(parentName, ".").concat(actionName), args);
      });
    } else {
